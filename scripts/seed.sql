...
INSERT INTO users (id, name, email, phone, timezone) VALUES
    ('a1000000-0000-0000-0000-000000000001', 'Pushkar', 'pushkar@example.com', '+919876543210', 'Asia/Kolkata'),
    ('a2000000-0000-0000-0000-000000000002', 'Sejal',   'sejal@example.com',   '+919876543211', 'Asia/Kolkata')
...
-- ── Transactions: Pushkar's HDFC Savings (April–May 2026) ────────────────────
...
-- transfer_id links this with Sejal's credit below
('c0700000-0000-0000-0000-000000000001',
 'b1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001',
 'seed-hdfc-savings-20260410-rent-transfer',
 1500000, 'INR', 'debit',
 'IMPS/RENT SHARE APR/Sejal', 'Sejal', 'sejal@sbi', 'imps', '2026-04-10'),
...
-- ── Transactions: Sejal's SBI Savings ─────────────────────────────────────────

INSERT INTO transactions (id, account_id, user_id, idempotency_key, amount, currency, direction,
    description, counterparty_name, counterparty_identifier, payment_mode, txn_date) VALUES

-- Salary credit to Sejal
...
-- Rent share received from Pushkar
('d0200000-0000-0000-0000-000000000001',
 'b3000000-0000-0000-0000-000000000003', 'a2000000-0000-0000-0000-000000000002',
 'seed-sbi-savings-20260410-rent-received',
 1500000, 'INR', 'credit',
 'IMPS/RENT SHARE APR/Pushkar', 'Pushkar', 'pushkar@hdfc', 'imps', '2026-04-10'),
...
(
    NULL,
    'Household rent is ₹30,000/month. Pushkar transfers ₹15,000 share to Sejal who pays the full rent to landlord Ramesh Kumar.',
